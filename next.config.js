...
const cspHeader = `
        default-src 'self' https://www3.doubleclick.net/ https://marketingplatform.google.com/about/enterprise/ https://api-gateway.umami.dev/api/send https://gateway.umami.is/api/send;
